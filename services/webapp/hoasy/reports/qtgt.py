    ...
    def render(self, cpvt=[]):
        ...
        for cp in cpvt:
            ...
            if cp['plcp'] == 'VTDL':
                ...
                moi.append(cp)
        return self.render_string(
            "reports/qtgt/oc-cpvt.html", cpvt=cpvt, moi=moi, sdl=sdl, tnk=tnk)
    ...
    def render(self, cpvt=[]):
        ...
        for cp in cpvt:
            ...
            if cp['plcp'] == 'VTDL':
                ...
                moi.append(cp)
        return self.render_string(
            "reports/qtgt/on-cpvt.html", cpvt=cpvt, moi=moi, sdl=sdl, tnk=tnk)
...
class Chiphi(web.UIModule):
    def render(self, chiphi=False):
        return self.render_string(
            "reports/qtgt/chiphi.html",
            cp=chiphi)


class ChiphiTieude(web.UIModule):
    def render(self, tieude=False):
        return self.render_string(
